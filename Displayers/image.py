...
class ImageViewer(object): 
    def setupUi(self, Viewer):
        ...
        self.image_2 = "..\\ressources\\DSC_0506.JPG" 
        self.image_1 = "..\\ressources\\JPG_dl1577292314664.jpg"				
        ...
        self.label.setPixmap(QtGui.QPixmap(self.image_2))
    ...
    def get_image(self):
        img = str(QFileDialog.getOpenFileName(Viewer, 
        ...
        if not img:
            ...
            return
        w_vue, h_vue = self.vue.width(), self.vue.height() 
        self.current_image = QtGui.QImage(img)
        self.pixmap = QtGui.QPixmap.fromImage(self.current_image.scaled(w_vue, h_vue,
                                    QtCore.Qt.KeepAspectRatio, 
                                    QtCore.Qt.SmoothTransformation)) 
        self.view_current()
